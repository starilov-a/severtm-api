...
final class UserServModeRepository extends ServiceEntityRepository implements UserServModeRepositoryInterface
{
    ...
    {
        $this->getEntityManager()->persist($userServMode);
